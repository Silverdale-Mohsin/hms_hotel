...
class HotelGuest(models.Model):
    ...
    reservation_count = fields.Integer(string="Reservation Count", compute='_compute_reservation_count', store=True, tracking=True, group_operator=False)
    card_count = fields.Integer(string="Card Count", compute='_compute_card_count', store=True, tracking=True, group_operator=False)
